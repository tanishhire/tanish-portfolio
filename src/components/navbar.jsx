...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 text-[#fff]'>
        <div>
        ...
        {/* Menu */}
          ...
          <button className='hidden md:flex btn bg-[#C4DAFF] p-2 rounded-md text-bold hover:scale-105'><a href="https://drive.google.com/file/d/1gLZe2F3rhN_fykDgVeeobFaKPVv-5dmI/view?usp=share_link"  target="_blank" rel="noopener noreferrer">Resume</a></button>
        ...
        {/* MObile Menu */}
        <ul className= {!nav ? 'hidden' :  "absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-[#14213D] to-[#181a1b] flex flex-col justify-center items-center"}>
