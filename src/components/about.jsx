...
const About = () => {
  return (
    <div name="about" className='w-full h-screen bg-[#0a192f] text-[#d6d6d6]'>
        <div className='flex flex-col justify-center items-center w-full h-full pl-4'>
          <div className='max-w-[1000px] w-full  grid grid-cols-2 gap-8'>
            ...
            <div>
                ...
                <a href='https://bit.ly/pcptanish' target='_blank' rel="noopener noreferrer"><p className='sm:text-left text-sm hover:text-[#B0D8BC]'>PCET's Pimpri Chinchwad Polytechnic, Pune (2018-2021)</p></a>
                ...
                <a href='https://bit.ly/aksharatanish' target='_blank' rel="noopener noreferrer"><p className='sm:text-left text-sm hover:text-[#B0D8BC]'>Akshara International School, Wakad (2017-2018)</p></a>
